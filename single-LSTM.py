...
#input_variables = ['h24_wind_speed','h24_wind_dir','h24_temperature','wind_avg','wind_direction','temperature']
#input_variables = ['h24_wind_speed','h24_wind_dir','h24_temperature','wind_avg','wind_max','wind_min','wind_direction','temperature']
input_variables = ['wind_avg','wind_direction','temperature']
...
model = Sequential()
model.add(LSTM(50, return_sequences=True, input_shape=(1, len(input_variables) )))
model.add(LSTM(50 ))
